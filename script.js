$('.start').click(function(){
    $('.stage1').fadeOut();
    fire_modal('https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/cake_modal.png','¡Hagamos un pastel!','Como es tu cumpleaños, me parece lógico que hagas tu propio pastel de cumpleaños digital, poke yo te hize el jueguito, Empieza por hacer tu mezcla para pastel, luego hornéalo en un horno digital y finalmente decora. Diviértete y feliz cumpleaños');
})
...
$('.mixer').click(function(){
    ...
    if(mixtimes == 6){
        $('.stage2').fadeOut();
        fire_modal('https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/mix_modal.png','¡Mezcla exitosa!','¡Enhorabuena, la mezcla es perfecta! Después de verter la mezcla en un molde para hornear, ahora es el momento de ponerlo en nuestro horno digital durante unos 3 segundos. Eso debería ser suficiente tiempo para una buena base esponjosa, me vas a compartir o q?');
...
$( ".oven" ).droppable({
    drop: function( event, ui ) {
        $('.stage3').fadeOut();
        fire_modal('https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/oven_modal.png','Hornear con éxito!','¡Sí! Eres un maestra de cocina. La base está completamente horneada y se ve súper rica. Ahora es el momento de combinar esta base con muchos otros ingredientes como mermelada, mermelada, chocolate y más.');
    }
})
